...
export default function Resume(){
    ...
    <section className='flex flex-col md:flex-row  bg-white border-x-2 border-b-2 border-lightlaven rounded-2xl p-8'  >
        ...
        <p className='font-bold pt-3 text-gray-800 text-lg leading-relaxed'>You can view my Resume <a ><button className=' uppercase text-white px-3 py-1 bg-[#7596F7] hover:bg-dkflame rounded-xl'><a href={config.link}>Download</a></button></a></p> 
