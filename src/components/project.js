...
export default function Project(){
    return <div className='pb-4 px-6 '>    
        ...
        <div className='my-6  flex flex-col md:flex-row gap-8 justify-center  '>
            ...
            <div className='p-4'>
                ...
                <div className='md:w-[350px] pl-5 md:pl-5 pr-2'>
                   ...
                   <div className='py-5  border '>
                    <button className=' flex   py-2 pl-3 pr-5 hover:border border-red-600 font-bold text-white bg-red-400 rounded-xl'>Explore
  ...
  <path fill-rule="evenodd" d="M3 10a.75.75 0 0 1 .75-.75h10.638L10.23 5.29a.75.75 0 1 1 1.04-1.08l5.5 5.25a.75.75 0 0 1 0 1.08l-5.5 5.25a.75.75 0 1 1-1.04-1.08l4.158-3.96H3.75A.75.75 0 0 1 3 10Z" clip-rule="evenodd" />
            ...
            <div className='border-4 border-dmint rounded-2xl  bg-gray-100'>
                ...
                <div className='md:w-[350px] pl-5  pr-2'>
                   ...
                   <div className='py-5 border   '>
                    <button className=' flex hover:border border-red-600 py-2 pl-3 pr-5 font-bold text-white bg-red-400 rounded-xl'>Explore
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 pt-1 pl-1 ">
  <path fill-rule="evenodd" d="M3 10a.75.75 0 0 1 .75-.75h10.638L10.23 5.29a.75.75 0 1 1 1.04-1.08l5.5 5.25a.75.75 0 0 1 0 1.08l-5.5 5.25a.75.75 0 1 1-1.04-1.08l4.158-3.96H3.75A.75.75 0 0 1 3 10Z" clip-rule="evenodd" />
</svg>
