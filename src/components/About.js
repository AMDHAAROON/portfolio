...
export default function(){
    ...
    return<div className=' px-6 pb-4'id='about'>
    <section className='flex flex-col md:flex-row  bg-flame rounded-2xl p-12 md:p-20 '  >
        ...
        <div className='flex flex-col  md:pl-8 '>
            ...
            <p className='pt-12 text-1xl font-design text-gray-600'> {config.line1}</p>
            <p className='pt-6 text-1xl font-design text-gray-600'>{config.line2} </p>
            <p className='pt-6 text-1xl font-design text-gray-600 '>{config.line3}</p>
            </div>
        </div>
    </section>
    </div>
